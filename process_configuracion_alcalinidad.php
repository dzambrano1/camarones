...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO cac_alcalinidad (cac_alcalinidad_vacuna, cac_alcalinidad_dosis, cac_alcalinidad_costo, cac_alcalinidad_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE cac_alcalinidad 
                    SET cac_alcalinidad_vacuna = :vacuna, 
                        cac_alcalinidad_dosis = :dosis, 
                        cac_alcalinidad_costo = :costo, 
                        cac_alcalinidad_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM cac_alcalinidad WHERE id = :id";

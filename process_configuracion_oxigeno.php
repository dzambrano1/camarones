...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO cac_oxygen (cac_oxygen_vacuna, cac_oxygen_dosis, cac_oxygen_costo, cac_oxygen_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE cac_oxygen 
                    SET cac_oxygen_vacuna = :vacuna, 
                        cac_oxygen_dosis = :dosis, 
                        cac_oxygen_costo = :costo, 
                        cac_oxygen_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM cac_oxygen WHERE id = :id";

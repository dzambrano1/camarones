...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO cac_ph (cac_ph_vacuna, cac_ph_dosis, cac_ph_costo, cac_ph_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE cac_ph 
                    SET cac_ph_vacuna = :vacuna, 
                        cac_ph_dosis = :dosis, 
                        cac_ph_costo = :costo, 
                        cac_ph_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM cac_ph WHERE id = :id";

...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO cac_redox (cac_redox_vacuna, cac_redox_dosis, cac_redox_costo, cac_redox_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE cac_redox 
                    SET cac_redox_vacuna = :vacuna, 
                        cac_redox_dosis = :dosis, 
                        cac_redox_costo = :costo, 
                        cac_redox_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM cac_redox WHERE id = :id";

...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO cac_transparencia (cac_transparencia_vacuna, cac_transparencia_dosis, cac_transparencia_costo, cac_transparencia_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE cac_transparencia 
                    SET cac_transparencia_vacuna = :vacuna, 
                        cac_transparencia_dosis = :dosis, 
                        cac_transparencia_costo = :costo, 
                        cac_transparencia_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM cac_transparencia WHERE id = :id";

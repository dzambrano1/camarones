...
// Fetch product options from cac_alcalinidad table
$productOptions = [];
try {
    $sql = "SELECT id, cac_alcalinidad_vacuna, cac_alcalinidad_dosis, cac_alcalinidad_costo FROM cac_alcalinidad ORDER BY cac_alcalinidad_vacuna ASC";
    $stmt = $conn->prepare($sql);
    $stmt->execute();
...
<div class="container text-center">
    ...
    REGISTROS DE NITRITOS
    </h3>



    <!-- New Water Alcalinidad Entry Modal -->
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newEntryModalLabel">
                    <i class="fas fa-plus-circle me-2"></i>Nuevo Registro Alcalinidad
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="newAlcalinidadForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-field">
                                <label for="new_alkalinity_mg_l">Nivel amoniaco (ppt)</label>
                                <div class="field-container">
                                    <i class="fas fa-water field-icon"></i>
                                    <input type="number" step="0.01" min="0" id="new_alkalinity_mg_l" name="alkalinity_mg_l" placeholder="Ej: 15.50" required>
                                </div>
                            </div>
                            <div class="form-field">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-field">
                                <label for="new_product">Producto Alcalinidad</label>
                                <div class="field-container">
                                    <i class="fas fa-syringe field-icon"></i>
                                    <select id="new_product" name="product" required>
                                        <option value="">Productos</option>
                                        <?php foreach ($productOptions as $product): ?>
                                            <option value="<?php echo htmlspecialchars($product['cac_alcalinidad_vacuna']); ?>">
                                                <?php echo htmlspecialchars($product['cac_alcalinidad_vacuna']); ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
            ...
            <div class="modal-footer btn-group">
                ...
                <button type="button" class="btn btn-success" id="saveNewAlcalinidad">
...
<div class="container mt-4 text-center">
    <button type="button" class="btn btn-success btn-lg" data-bs-toggle="modal" data-bs-target="#newEntryModal">
        <i class="fas fa-plus me-2"></i>Nuevo Registro de Alcalinidad
    </button>
  </div>
  
<!-- Simple DataTable for Water Alcalinidad Records -->
<div class="container mt-5 mb-5">
    <div class="card shadow">
        <div class="card-header bg-info text-white">
            <h5 class="mb-0 text-center"><i class="fas fa-table me-2"></i>Registros de Alcalinidad</h5>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table id="alcalinidadTable" class="table table-striped table-bordered">
                    <thead class="table-dark">
                        <tr>
                            <th class="text-center">ID Estanque</th>
                            <th class="text-center">Alcalinidad (mg/L)</th>
...
<div class="modal fade modern-modal" id="editAlcalinidadModal" tabindex="-1" aria-labelledby="editAlcalinidadModalLabel">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editAlcalinidadModalLabel">
                    <i class="fas fa-edit me-2"></i>Editar Registros Alcalinidad
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="editAlcalinidadForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-field">
                                <label for="edit_alcalinidad_level">Nivel Alcalinidad (mg/L)</label>
                                <div class="field-container">
                                    <i class="fas fa-tint field-icon"></i>
                                    <input type="number" step="0.01" min="0" id="edit_alcalinidad_level" name="alkalinity_mg_l" placeholder="Ej: 15.50" required>
                                </div>
                            </div>
                            <div class="form-field">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-field">
                                <label for="edit_product">Producto Alcalinidad</label>
                                <div class="field-container">
                                    <i class="fas fa-syringe field-icon"></i>
            ...
            <div class="modal-footer btn-group">
                ...
                <button type="button" class="btn btn-success" id="saveEditAlcalinidad">
                    <i class="fas fa-save me-1"></i>Guardar
                </button>
            </div>
        </div>
...
<!-- Water Alcalinidad Statistics -->
<div class="container mt-5 mb-5">
    <div class="row">
                <div class="col-md-4">
            <div class="card shadow">
                <div class="card-header bg-info text-white">
                    <h6 class="mb-0"><i class="fas fa-tint me-2"></i>Alcalinidad Promedio</h6>
                </div>
                <div class="card-body text-center">
                    <h4 id="avgAlcalinidad">-- ppt</h4>
                    </div>
                    </div>
                    </div>
        <div class="col-md-4">
            <div class="card shadow">
                <div class="card-header bg-success text-white">
                    <h6 class="mb-0"><i class="fas fa-arrow-up me-2"></i>Alcalinidad Máxima</h6>
                </div>
                <div class="card-body text-center">
                    <h4 id="maxAlcalinidad">-- ppt</h4>
                    </div>
                    </div>
                     </div>
        <div class="col-md-4">
            <div class="card shadow">
                <div class="card-header bg-warning text-white">
                    <h6 class="mb-0"><i class="fas fa-arrow-down me-2"></i>Alcalinidad Mínima</h6>
                </div>
                <div class="card-body text-center">
                    <h4 id="minAlcalinidad">-- ppt</h4>
                    </div>
            </div>
        </div>
    </div>
...
$(document).ready(function() {
    // Load alcalinidad statistics
    function loadStatistics() {
        $.ajax({
            url: 'get_water_alcalinidad_data.php',
            type: 'GET',
            dataType: 'json',
            success: function(response) {
                if (!response.success || !response.records || response.records.length === 0) {
                    $('#avgAlcalinidad').text('-- mg/L');
                    $('#maxAlcalinidad').text('-- mg/L');
                    $('#minAlcalinidad').text('-- mg/L');
                    return;
                }

                // Calculate statistics from alkalinity_mg_l column
                const alcalinidadLevels = response.records
                    .map(item => parseFloat(item.alkalinity_mg_l))
                    .filter(value => !isNaN(value) && value > 0); // Filter out invalid values
                
                if (alcalinidadLevels.length === 0) {
                    $('#avgAlcalinidad').text('-- mg/L');
                    $('#maxAlcalinidad').text('-- mg/L');
                    $('#minAlcalinidad').text('-- mg/L');
                    return;
                ...
                const avgAlcalinidad = alcalinidadLevels.reduce((a, b) => a + b, 0) / alcalinidadLevels.length;
                const maxAlcalinidad = Math.max(...alcalinidadLevels);
                const minAlcalinidad = Math.min(...alcalinidadLevels);
                
                // Update display with proper formatting
                $('#avgAlcalinidad').text(avgAlcalinidad.toFixed(2) + ' mg/L');
                $('#maxAlcalinidad').text(maxAlcalinidad.toFixed(2) + ' mg/L');
                $('#minAlcalinidad').text(minAlcalinidad.toFixed(2) + ' mg/L');
            },
            error: function(xhr, status, error) {
                console.error('Error loading statistics:', error);
                $('#avgAlcalinidad').text('Error');
                $('#maxAlcalinidad').text('Error');
                $('#minAlcalinidad').text('Error');
            }
        });
    }
    ...
    if (typeof alcalinidadDataTable !== 'undefined') {
        alcalinidadDataTable.on('xhr.dt', function() {
            loadStatistics();
        });
    }
});
</script>
<!-- Monthly alcalinidad Trends Chart -->
<div class="container mt-5 mb-5">
    <div class="card shadow">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0 text-center">
                <i class="fas fa-chart-line me-2"></i>Tendencias de alcalinidad Mensual por Estanque
            </h5>
        </div>
        <div class="card-body">
            <!-- Filter Controls -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="chart-container" style="position: relative; height: 500px; width: 100%;">
                        <canvas id="alcalinidadChart" style="width: 100%; height: 100%;"></canvas>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <small class="text-muted">
                        ...
                        Este gráfico muestra los niveles de alcalinidad promedio mensuales para cada estanque.
...
<script>
// alcalinidad Chart Variables
let alcalinidadChart = null;
let alcalinidadChartData = {};

// Initialize alcalinidad Chart
function initalcalinidadChart() {
    const ctx = document.getElementById('alcalinidadChart').getContext('2d');
    
    alcalinidadChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: [],
            datasets: []
        ...
        options: {
            ...
            plugins: {
                title: {
                    display: true,
                    text: 'Alcalinidad Promedio Mensual por Estanque',
                    font: {
                        size: 16,
                        weight: 'bold'
                    }
                ...
                tooltip: {
                    ...
                    callbacks: {
                        ...
                        label: function(context) {
                            ...
                            if (value !== null) {
                                return datasetLabel + ': ' + value.toFixed(2) + 'mg/L';
                            }
    ...
    setTimeout(() => {
        alcalinidadChart.resize();
    }, 100);
}

// Load alcalinidad Chart Data
function loadalcalinidadData(tagidFilter = 'all') {
    const url = `get_monthly_alcalinidad_data.php${tagidFilter !== 'all' ? '?tagid=' + encodeURIComponent(tagidFilter) : ''}`;
    ...
    fetch(url)
        ...
        .then(data => {
            if (data.success) {
                ...
                alcalinidadChartData = data;
                
                // Update chart
                alcalinidadChart.data.labels = data.labels;
                alcalinidadChart.data.datasets = data.datasets;
                alcalinidadChart.update();
                ...
                console.log('alcalinidad chart updated successfully');
            } else {
                console.error('Error loading alcalinidad data:', data.message);
                Swal.fire({
                    title: 'Error',
        ...
        .catch(error => {
            console.error('Error fetching alcalinidad data:', error);
            Swal.fire({
                title: 'Error',
...
// Initialize alcalinidad chart when page loads
$(document).ready(function() {
    // Initialize chart
    initalcalinidadChart();
    ...
    $('#pond-filter').on('change', function() {
        ...
        loadalcalinidadData(selectedPond);
    });
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('saveNewAlcalinidad').addEventListener('click', saveNewRecord);
    document.getElementById('saveEditAlcalinidad').addEventListener('click', saveEditRecord);
});

// Initialize DataTable (CRUD))
function initializeDataTable() {
    alcalinidadDataTable = $('#alcalinidadTable').DataTable({
        ajax: {
            url: 'get_water_alcalinidad_data.php',
            type: 'GET',
        ...
        columns: [
            ...
            { 
                data: 'alkalinity_mg_l', 
                title: 'Alcalinidad (mg/L)',
                className: 'text-center',
        ...
        buttons: [
            ...
            },
            {
                ...
                filename: 'alcalinidad_' + new Date().toISOString().split('T')[0]
            },
            {
                extend: 'excel',
    ...
    $('#alcalinidadTable_filter input').attr('placeholder', 'Buscar en todos los campos...');
...
function editRecord(id) {
    ...
    const rowData = alcalinidadDataTable.rows().data().toArray().find(r => r.id == id);
    if (!rowData) return;
    ...
    document.getElementById('edit_alcalinidad_level').value = rowData.alkalinity_mg_l;
    ...
    // Show modal
    const modal = new bootstrap.Modal(document.getElementById('editAlcalinidadModal'));
    modal.show();
}
...
function deleteRecord(id, pondId) {
    Swal.fire({
        ...
        fetch('process_water_alcalinidad.php', {
        method: 'POST',
        headers: {
    ...
    .then(data => {
        if (data.success) {
            ...
            alcalinidadDataTable.ajax.reload(); // Reload DataTable
...
function saveNewRecord() {
    const formData = {
        ...
        alkalinity_mg_l: document.getElementById('new_alkalinity_mg_l').value,
    ...
    .then(data => {
        if (data.success) {
            if (data.warning) {
                // Show warning first, then success
                Swal.fire({
                    icon: 'warning',
                    title: '⚠️ Advertencia',
                    text: data.warning,
                    ...
                    Swal.fire({
                        icon: 'success',
                        title: '¡Éxito!',
                        text: 'Registro creado exitosamente (con advertencia)',
                        showConfirmButton: false,
                        timer: 2500,
                        timerProgressBar: true
                    });
            ...
            document.getElementById('newAlcalinidadForm').reset();
...
function saveEditRecord() {
    const formData = {
        ...
        alkalinity_mg_l: document.getElementById('edit_alcalinidad_level').value,
    ...
    .then(data => {
        if (data.success) {
            if (data.warning) {
                ...
                Swal.fire({
                    ...
                    Swal.fire({
                        icon: 'success',
                        title: '¡Actualizado!',
                        text: 'Registro actualizado exitosamente (con advertencia)',
                        showConfirmButton: false,
                        timer: 2500,
                        timerProgressBar: true
                    });
            ...
            const modal = bootstrap.Modal.getInstance(document.getElementById('editAlcalinidadModal'));
            modal.hide();
            alcalinidadDataTable.ajax.reload(); // Reload DataTable
            $(document).trigger('tableUpdated'); // Trigger statistics update
        } else {

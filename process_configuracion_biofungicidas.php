...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO cac_biofungicida (cac_biofungicida_vacuna, cac_biofungicida_dosis, cac_biofungicida_costo, cac_biofungicida_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE cac_biofungicida 
                    SET cac_biofungicida_vacuna = :vacuna, 
                        cac_biofungicida_dosis = :dosis, 
                        cac_biofungicida_costo = :costo, 
                        cac_biofungicida_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM cac_biofungicida WHERE id = :id";

...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO cac_nitritos (cac_nitritos_vacuna, cac_nitritos_dosis, cac_nitritos_costo, cac_nitritos_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE cac_nitritos 
                    SET cac_nitritos_vacuna = :vacuna, 
                        cac_nitritos_dosis = :dosis, 
                        cac_nitritos_costo = :costo, 
                        cac_nitritos_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM cac_nitritos WHERE id = :id";

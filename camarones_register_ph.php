...
<title>Camarones Register ph</title>
<!-- Link to the Favicon -->
    ...
    <div class="card shadow-sm reference-table-card">
      <div class="card-header bg-info text-white">
        <h5 class="mb-0 text-center text-white">
          <i class="fas fa-chart-bar me-2"></i>🧂 Rangos óptimos de ph para Litopenaeus vannamei
        </h5>
      </div>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover mb-0">
            <thead class="table-dark">
              <tr>
                <th class="text-center" style="width: 20%;">Valor en Fase</th>
                <th class="text-center" style="width: 50%;">Descripción</th>
                <th class="text-center" style="width: 30%;">Rango óptimo de ph</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <td class="text-center">
                  <span class="badge bg-danger fs-6">15–25 ppt</span>
                </td>
              </tr>
              <tr>
                <td class="text-center fw-bold text-success">
                  <span class="badge bg-success">juvenil</span>
                </td>
                <td class="text-center">Juveniles (1–5 g)</td>
                <td class="text-center">
                  <span class="badge bg-warning text-dark fs-6">10–25 ppt</span>
                </td>
              </tr>
              <tr>
                <td class="text-center fw-bold text-info">
                  <span class="badge bg-info">engorde</span>
                </td>
                <td class="text-center">Engorde (>5 g)</td>
                <td class="text-center">
                  <span class="badge bg-success fs-6">5–25 ppt</span>
                </td>
              </tr>
              <tr>
                <td class="text-center fw-bold text-warning">
                  <span class="badge bg-warning text-dark">pre-cosecha</span>
                </td>
                <td class="text-center">Pre-cosecha</td>
                <td class="text-center">
                  <span class="badge bg-info fs-6">10–20 ppt</span>
                </td>
              </tr>
              <tr>
                <td class="text-center fw-bold text-secondary">
                  <span class="badge bg-secondary">Criadero</span>
                </td>
                <td class="text-center">Fase intermedia (si aplica)</td>
                <td class="text-center">
                  <span class="badge bg-warning text-dark fs-6">15–25 ppt</span>
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <div class="card-footer bg-light text-muted text-center small">
        ...
        Rangos de ph óptimos para cada fase del cultivo de camarón blanco del Pacífico (ppt = partes por mil)
      </div>
    </div>
  </div>
   
  <!-- New Water pH Entry Modal -->
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newEntryModalLabel">
                    <i class="fas fa-plus-circle me-2"></i>Nuevo Registro ph
                </h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-field">
                             ...
                             <div class="form-field">
                                 <label for="new_ph_level">Nivel ph (ppt)</label>
                                 <div class="field-container">
                                     <i class="fas fa-tint field-icon"></i>
                                     <input type="number" step="0.01" min="0" id="new_ph_level" name="ph_level" placeholder="Ej: 15.50" required>
                                 </div>
                             </div>
                             <div class="form-field">
                            ...
                            <div class="form-field">
                                ...
                                <div class="field-container">
                                    ...
                                    <select id="new_source" name="source" required>
                                        ...
                                        <!-- Options will be loaded dynamically from cac_sensores table -->
                                    </select>
                                </div>
                            </div>
                            <div class="form-field">
                                ...
                                <div class="field-container">
                                    ...
                                    <select id="new_phase" name="phase" required>
                                        ...
                                        <!-- Options will be loaded dynamically from cac_etapas table -->
                                    </select>
                                </div>
                            </div>
                            <div class="form-field">
                                <label for="new_product">Producto pH</label>
                                <div class="field-container">
                                    <i class="fas fa-syringe field-icon"></i>
                                    <select id="new_product" name="product" required>
                                        <option value="">Producto</option>
                                        <!-- Options will be loaded dynamically from cac_ph table -->
                                    </select>
                                </div>
                            </div>
                            <div class="form-field">
            ...
            <div class="modal-footer btn-group">
                ...
                <button type="button" class="btn btn-success" id="saveNewph">
...
<div class="container mt-4 text-center">
    <button type="button" class="btn btn-success btn-lg" data-bs-toggle="modal" data-bs-target="#newEntryModal">
        <i class="fas fa-plus me-2"></i>Nuevo Registro de ph
    </button>
</div>

<!-- DataTable for water_ph_log records -->
<div class="container mt-5 mb-5">
    <div class="card shadow">
        <div class="card-header bg-secondary text-white">
            <h5 class="mb-0 text-center"><i class="fas fa-table me-2"></i>Registros de ph del Agua</h5>
        </div>

        <div class="card-body">
            <table id="phTable" class="table table-striped table-bordered">
                <thead>
                    <tr>
                        
                        <th class="text-center">ID</th>
                        <th class="text-center">Estanque</th>
                        <th class="text-center">ph (ppt)</th>
...
<!-- Modal for Edit Water Salinity -->
<div class="modal fade modern-modal" id="editphModal" tabindex="-1" aria-labelledby="editphModalLabel">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editphModalLabel">
                    <i class="fas fa-edit me-2"></i>Editar ph del Estanque
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="editphForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-field">
                                <label for="edit_ph_level">Nivel pH (ppt)</label>
                                <div class="field-container">
                                    <i class="fas fa-tint field-icon"></i>
                                    <input type="number" step="0.01" min="0" id="edit_ph_level" name="ph_level" placeholder="Ej: 15.50" required>
                                </div>
                            </div>
                        </div>
                        <!-- Right Column -->
                        <div class="col-md-6">
                            ...
                            <div class="form-field">
                                <label for="edit_product">Producto pH</label>
                                <div class="field-container">
                                    <i class="fas fa-syringe field-icon"></i>
            ...
            <div class="modal-footer btn-group">
                ...
                <button type="button" class="btn btn-success" id="saveEditph">
                    <i class="fas fa-save me-1"></i>Guardar
                </button>
            </div>
        </div>
...
<!-- JavaScript for Water pH CRUD operations -->
<script>
$(document).ready(function() {
    // Initialize DataTable
    var table = $('#phTable').DataTable({
        ajax: {
            url: 'get_water_ph_data.php',
            type: 'GET',
        ...
        columns: [
            ...
            { 
                ...
                render: function(data) {
                    return parseFloat(data).toFixed(2) + ' ppt';
                }
            },
            { 
                data: 'source', 
                className: 'text-center',
                render: function(data) {
                    // Dynamic source labels based on database values
                    const sourceLabels = {
                        'Refractometro': 'Refractómetro',
                        'Conductimetro': 'Conductímetro', 
                        'Automatico': 'Sensor Automático',
            ...
            },
            {
                ...
                className: 'text-center',
                render: function(data) {
                    // Dynamic phase labels based on database values
                    const phaseLabels = {
                        'Postlarval': 'Postlarval',
                        'Juvenil': 'Juvenil',
                        'Criadero': 'Criadero',
                        'Engorde': 'Engorde',
                        'Pre-cocecha': 'Pre-cosecha',
                        // Legacy support for existing data
                        'PL': 'Postlarvas (PL)',
                        'juvenile': 'Juveniles',
                        'growout': 'Engorde',
                        'preharvest': 'Pre-cosecha',
                        'nursery': 'Nursery',
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    return `
                        <button class="btn btn-sm btn-warning edit-ph me-1" 
                                data-id="${row.id}" 
                                data-pond_id="${row.pond_id}" 
                                data-ph_level="${row.ph_level}" 
                        ...
                        <button class="btn btn-sm btn-danger delete-ph" 
                                data-id="${row.id}" 
                                data-pond_id="${row.pond_id}"
                                title="Eliminar">
    ...
    // Load sensor options dynamically
    function loadSensorOptions() {
        $.ajax({
            url: 'get_sensor_options.php',
            type: 'GET',
            dataType: 'json',
            success: function(response) {
                if (response.success && response.sensors) {
                    // Clear existing options (except placeholder)
                    $('#new_source').html('<option value="">Sensor</option>');
                    $('#edit_source').html('<option value="">Sensor</option>');
                    
                    // Add sensor options
                    response.sensors.forEach(function(sensor) {
                        const option = `<option value="${sensor.sensores}">${sensor.sensores}</option>`;
                        $('#new_source').append(option);
                        $('#edit_source').append(option);
                    });
                } else {
                    console.error('Error loading sensor options:', response.message);
                }
            },
    ...
    // Load phase options dynamically
    function loadPhaseOptions() {
        $.ajax({
            url: 'get_phase_options.php',
            type: 'GET',
            dataType: 'json',
            success: function(response) {
                if (response.success && response.phases) {
                    // Clear existing options (except placeholder)
                    $('#new_phase').html('<option value="">Fase</option>');
                    $('#edit_phase').html('<option value="">Fase</option>');
                    
                    // Add phase options
                    response.phases.forEach(function(phase) {
                        const option = `<option value="${phase.cac_etapas_nombre.trim()}">${phase.cac_etapas_nombre.trim()}</option>`;
                        $('#new_phase').append(option);
                        $('#edit_phase').append(option);
                    });
                } else {
                    console.error('Error loading phase options:', response.message);
                }
            },
            error: function(xhr, status, error) {
    ...
    function loadProductOptions() {
        $.ajax({
            url: 'get_ph_product_options.php',
            type: 'GET',
            dataType: 'json',
            success: function(response) {
                if (response.success && response.products) {
                    // Clear existing options (except placeholder)
                    $('#new_product').html('<option value="">Producto</option>');
                    $('#edit_product').html('<option value="">Producto</option>');
                    
                    // Add product options
                    response.products.forEach(function(product) {
                        const option = `<option value="${product.cac_ph_vacuna}">${product.cac_ph_vacuna}</option>`;
                        $('#new_product').append(option);
                        $('#edit_product').append(option);
                    });
                } else {
                    console.error('Error loading product options:', response.message);
                }
            },
            error: function(xhr, status, error) {
    ...
    // Load sensor, phase, and product options on page load
    loadSensorOptions();
    loadPhaseOptions();
    loadProductOptions();

    // Handle new entry form submission
    $('#saveNewph').click(function() {
        // Validate the form
        var form = document.getElementById('newphForm');
        ...
        var formData = {
            ...
            ph_level: $('#new_ph_level').val(),
            source: $('#new_source').val(),
            phase: $('#new_phase').val(),
            fecha: $('#new_fecha').val(),
            hora: $('#new_hora').val(),
            product: $('#new_product').val(),
            product_qty: $('#new_product_qty').val(),
            product_price: $('#new_product_price').val()
        };
        
        // Show confirmation dialog using SweetAlert2
        Swal.fire({
            title: '¿Confirmar registro?',
            text: `¿Desea registrar el nivel de ph ${formData.ph_level} ppt para el estanque ${formData.pond_id}?`,
            icon: 'question',
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        ...
                        // Check if xhr.responseJSON exists (jQuery parsed it automatically)
    ...
    $(document).on('click', '.edit-ph', function() {
        ...
        var ph_level = $(this).data('ph_level');
        ...
        $('#edit_product_qty').val(product_qty || '');
    ...
    // Handle edit form submission
        $('#saveEditph').click(function() {
        // Validate the form
        var form = document.getElementById('editphForm');
        if (!form.checkValidity()) {
            form.reportValidity();
            return;
        }
            ...
            text: `¿Desea actualizar el registro de ph?`,
                icon: 'question',
                showCancelButton: true,
                confirmButtonColor: '#007bff',
                cancelButtonColor: '#dc3545',
    ...
    $(document).on('click', '.delete-ph', function() {
        var id = $(this).data('id');
        var pond_id = $(this).data('pond_id');
        ...
        Swal.fire({
            ...
            text: `¿Está seguro eliminar el registro para el estanque ${pond_id}? Esta acción no se puede deshacer.`,
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#dc3545',
...
<!-- Water Salinity Statistics -->
<div class="container mt-5 mb-5">
    <div class="row">
                <div class="col-md-4">
            <div class="card shadow">
                <div class="card-header bg-info text-white">
                    <h6 class="mb-0"><i class="fas fa-tint me-2"></i>ph Promedio</h6>
                </div>
                <div class="card-body text-center">
                    <h4 id="avgSalinity">-- ppt</h4>
                    </div>
                    </div>
                    </div>
        <div class="col-md-4">
            <div class="card shadow">
                <div class="card-header bg-success text-white">
                    <h6 class="mb-0"><i class="fas fa-arrow-up me-2"></i>ph Máxima</h6>
                </div>
                <div class="card-body text-center">
                    <h4 id="maxSalinity">-- ppt</h4>
                    </div>
                    </div>
                     </div>
        <div class="col-md-4">
            <div class="card shadow">
                <div class="card-header bg-warning text-white">
                    <h6 class="mb-0"><i class="fas fa-arrow-down me-2"></i>ph Mínima</h6>
                </div>
                <div class="card-body text-center">
                    <h4 id="minSalinity">-- ppt</h4>
                    </div>
            </div>
        </div>
    </div>
    ...
    $.ajax({
        ...
        success: function(data) {
                if (data.error || !Array.isArray(data) || data.length === 0) {
                    $('#avgSalinity').text('-- ppt');
                    $('#maxSalinity').text('-- ppt');
                    $('#minSalinity').text('-- ppt');
                return;
            }

                // Calculate statistics
                const salinities = data.map(item => parseFloat(item.ph_level));
                ...
                // Update display
                $('#avgSalinity').text(avgSalinity.toFixed(2) + ' ppt');
                $('#maxSalinity').text(maxSalinity.toFixed(2) + ' ppt');
                $('#minSalinity').text(minSalinity.toFixed(2) + ' ppt');
        },
        error: function(xhr, status, error) {
                console.error('Error loading statistics:', error);
                $('#avgSalinity').text('Error');
                $('#maxSalinity').text('Error');
                $('#minSalinity').text('Error');
            }
        });
    }
...
<!-- Monthly ph Trends Chart -->
<div class="container mt-5 mb-5">
    <div class="card shadow">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0 text-center">
                <i class="fas fa-chart-line me-2"></i>Tendencias de ph Mensual por Estanque
            </h5>
        </div>
        <div class="card-body">
            <!-- Filter Controls -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="chart-container" style="position: relative; height: 500px; width: 100%;">
                        <canvas id="phChart" style="width: 100%; height: 100%;"></canvas>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <small class="text-muted">
                        <i class="fas fa-info-circle me-1"></i>
                        Este gráfico muestra las phs promedio mensuales para cada estanque. 
    ...
    phChart = new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                title: {
                    display: true,
                    text: 'ph Promedio Mensual por Estanque',
                    font: {
                        size: 16,
                        weight: 'bold'
                    }
...
// Load ph Chart Data
function loadphData(tagidFilter = 'all') {
    const url = `get_monthly_ph_data.php${tagidFilter !== 'all' ? '?tagid=' + encodeURIComponent(tagidFilter) : ''}`;
    ...
    fetch(url)
        ...
        .then(data => {
            if (data.success) {
                ...
                phChart.data.datasets = data.datasets;
                phChart.update();
                ...
                console.log('ph chart updated successfully');
            } else {
                console.error('Error loading ph data:', data.message);
                Swal.fire({
                    title: 'Error',
                    text: 'Error al cargar datos de ph: ' + data.message,
                    icon: 'error',
                    confirmButtonColor: '#dc3545'
                });
            }
        ...
        .catch(error => {
            ...
            Swal.fire({
                title: 'Error',
                text: 'Error al obtener datos de ph',
                icon: 'error',
                confirmButtonColor: '#dc3545'
            });
        });
...
// Initialize ph chart when page loads
$(document).ready(function() {
    // Initialize chart
    initphChart();

...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO cac_ammonia (cac_ammonia_vacuna, cac_ammonia_dosis, cac_ammonia_costo, cac_ammonia_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE cac_ammonia 
                    SET cac_ammonia_vacuna = :vacuna, 
                        cac_ammonia_dosis = :dosis, 
                        cac_ammonia_costo = :costo, 
                        cac_ammonia_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM cac_ammonia WHERE id = :id";

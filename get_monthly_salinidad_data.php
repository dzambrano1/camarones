...
try {
    ...
    $pond_sql = "SELECT DISTINCT pond_id FROM water_salinity_log ORDER BY pond_id";
    ...
    foreach ($results as $row) {
        ...
        $pondData[$pondId][$monthKey] = round(floatval($row['avg_salinity']), 2);
    }
    ...
    echo json_encode([
        'success' => false,
        'message' => 'Error al obtener datos de salinidad: ' . $e->getMessage()
    ]);
}

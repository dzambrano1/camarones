...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO cac_salinidad (cac_salinidad_vacuna, cac_salinidad_dosis, cac_salinidad_costo, cac_salinidad_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE cac_salinidad 
                    SET cac_salinidad_vacuna = :vacuna, 
                        cac_salinidad_dosis = :dosis, 
                        cac_salinidad_costo = :costo, 
                        cac_salinidad_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM cac_salinidad WHERE id = :id";

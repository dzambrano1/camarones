...
// Fetch product options from cac_salinidad table
$productOptions = [];
try {
    $sql = "SELECT id, cac_salinidad_vacuna, cac_salinidad_dosis, cac_salinidad_costo FROM cac_salinidad ORDER BY cac_salinidad_vacuna ASC";
    $stmt = $conn->prepare($sql);
    $stmt->execute();
...
<title>Camarones Register Salinidad</title>
<!-- Link to the Favicon -->
...
<div class="container text-center">
    ...
    REGISTROS DE SALINIDAD
    </h3>



    <!-- New Water Salinidad Entry Modal -->
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newEntryModalLabel">
                    <i class="fas fa-plus-circle me-2"></i>Nuevo Registro Salinidad
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="newSalinidadForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-field">
                             ...
                             <div class="form-field">
                                 <label for="new_salinidad_level">Nivel salinidad (ppt)</label>
                                 <div class="field-container">
                                     <i class="fas fa-water field-icon"></i>
                                     <input type="number" step="0.01" min="0" id="new_salinidad_level" name="salinity_ppt" placeholder="Ej: 15.50" required>
                                 </div>
                             </div>
                             <div class="form-field">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-field">
                                <label for="new_product">Producto Salinidad</label>
                                <div class="field-container">
                                    ...
                                    <select id="new_product" name="product" required>
                                        ...
                                        <?php foreach ($productOptions as $product): ?>
                                            <option value="<?php echo htmlspecialchars($product['cac_salinidad_vacuna']); ?>">
                                                <?php echo htmlspecialchars($product['cac_salinidad_vacuna']); ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
            ...
            <div class="modal-footer btn-group">
                ...
                <button type="button" class="btn btn-success" id="saveNewSalinidad">
...
<div class="container mt-4 text-center">
    <button type="button" class="btn btn-success btn-lg" data-bs-toggle="modal" data-bs-target="#newEntryModal">
        <i class="fas fa-plus me-2"></i>Nuevo Registro de Salinidad
    </button>
  </div>
  
<!-- Simple DataTable for Water Salinity Records -->
<div class="container mt-5 mb-5">
    <div class="card shadow">
        <div class="card-header bg-info text-white">
            <h5 class="mb-0 text-center"><i class="fas fa-table me-2"></i>Registros de Salinidad</h5>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table id="salinityTable" class="table table-striped table-bordered">
                    <thead class="table-dark">
                        <tr>
                            <th class="text-center">ID Estanque</th>
                            <th class="text-center">Salinidad (ppt)</th>
...
<div class="modal fade modern-modal" id="editSalinidadModal" tabindex="-1" aria-labelledby="editSalinidadModalLabel">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editSalinidadModalLabel">
                    <i class="fas fa-edit me-2"></i>Editar salinidad del Estanque
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="editSalinidadForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-field">
                                <label for="edit_salinidad_level">Nivel Salinidad (ppt)</label>
                                <div class="field-container">
                                    <i class="fas fa-tint field-icon"></i>
                                    <input type="number" step="0.01" min="0" id="edit_salinidad_level" name="salinity_ppt" placeholder="Ej: 15.50" required>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-field">
                                <label for="edit_product">Producto Salinidad</label>
                                <div class="field-container">
                                    <i class="fas fa-syringe field-icon"></i>
            ...
            <div class="modal-footer btn-group">
                ...
                <button type="button" class="btn btn-success" id="saveEditSalinidad">
                    <i class="fas fa-save me-1"></i>Guardar
                </button>
            </div>
        </div>
...
<div class="container mt-5 mb-5">
    <div class="row">
            ...
            <div class="card shadow">
                <div class="card-header bg-info text-white">
                    <h6 class="mb-0"><i class="fas fa-tint me-2"></i>Salinidad Promedio</h6>
                </div>
        ...
        <div class="col-md-4">
            <div class="card shadow">
                <div class="card-header bg-success text-white">
                    <h6 class="mb-0"><i class="fas fa-arrow-up me-2"></i>Salinidad Máxima</h6>
                </div>
                <div class="card-body text-center">
        ...
        <div class="col-md-4">
            <div class="card shadow">
                <div class="card-header bg-warning text-white">
                    <h6 class="mb-0"><i class="fas fa-arrow-down me-2"></i>Salinidad Mínima</h6>
                </div>
                <div class="card-body text-center">
...
$(document).ready(function() {
    // Load salinidad statistics
    function loadStatistics() {
        $.ajax({
            url: 'get_simple_salinity_data.php',
            type: 'GET',
            dataType: 'json',
            success: function(response) {
                ...
                // Calculate statistics from salinity_ppt column
                const salinities = response.records
                    .map(item => parseFloat(item.salinity_ppt))
    ...
    if (typeof salinityDataTable !== 'undefined') {
        salinityDataTable.on('xhr.dt', function() {
            loadStatistics();
        });
    }
});
</script>
<!-- Monthly salinidad Trends Chart -->
<div class="container mt-5 mb-5">
    <div class="card shadow">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0 text-center">
                <i class="fas fa-chart-line me-2"></i>Tendencias de salinidad Mensual por Estanque
            </h5>
        </div>
        <div class="card-body">
            <!-- Filter Controls -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="chart-container" style="position: relative; height: 500px; width: 100%;">
                        <canvas id="salinidadChart" style="width: 100%; height: 100%;"></canvas>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <small class="text-muted">
                        ...
                        Este gráfico muestra las salinidades promedio mensuales para cada estanque.
...
<script>
// salinidad Chart Variables
let salinidadChart = null;
let salinidadChartData = {};

// Initialize salinidad Chart
function initsalinidadChart() {
    const ctx = document.getElementById('salinidadChart').getContext('2d');
    
    salinidadChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: [],
            datasets: []
        ...
        options: {
            ...
            plugins: {
                title: {
                    display: true,
                    text: 'Salinidad Promedio Mensual por Estanque',
                    font: {
                        size: 16,
                        weight: 'bold'
                    }
    ...
    setTimeout(() => {
        salinidadChart.resize();
    }, 100);
}

// Load salinidad Chart Data
function loadsalinidadData(tagidFilter = 'all') {
    const url = `get_monthly_salinidad_data.php${tagidFilter !== 'all' ? '?tagid=' + encodeURIComponent(tagidFilter) : ''}`;
    ...
    fetch(url)
        ...
        .then(data => {
            if (data.success) {
                ...
                salinidadChartData = data;
                
                // Update chart
                salinidadChart.data.labels = data.labels;
                salinidadChart.data.datasets = data.datasets;
                salinidadChart.update();
                ...
                console.log('salinidad chart updated successfully');
            } else {
                console.error('Error loading salinidad data:', data.message);
                Swal.fire({
                    title: 'Error',
                    text: 'Error al cargar datos de salinidad: ' + data.message,
                    icon: 'error',
        ...
        .catch(error => {
            console.error('Error fetching salinidad data:', error);
            Swal.fire({
                title: 'Error',
                text: 'Error al obtener datos de salinidad',
                icon: 'error',
                confirmButtonColor: '#dc3545'
            });
        });
...
// Initialize salinidad chart when page loads
$(document).ready(function() {
    // Initialize chart
    initsalinidadChart();
    ...
    $('#pond-filter').on('change', function() {
        ...
        loadsalinidadData(selectedPond);
    });
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('saveNewSalinidad').addEventListener('click', saveNewRecord);
    document.getElementById('saveEditSalinidad').addEventListener('click', saveEditRecord);
});

// Initialize DataTable with full features
function initializeDataTable() {
    salinityDataTable = $('#salinityTable').DataTable({
        ajax: {
            url: 'get_simple_salinity_data.php',
            type: 'GET',
        ...
        buttons: [
            ...
            },
            {
                ...
                filename: 'salinidad_' + new Date().toISOString().split('T')[0]
            },
            {
                extend: 'excel',
    ...
    $('#salinityTable_filter input').attr('placeholder', 'Buscar en todos los campos...');
...
function editRecord(id) {
    ...
    const rowData = salinityDataTable.rows().data().toArray().find(r => r.id == id);
    if (!rowData) return;
    ...
    document.getElementById('edit_salinidad_level').value = rowData.salinity_ppt;
    ...
    // Show modal
    const modal = new bootstrap.Modal(document.getElementById('editSalinidadModal'));
    modal.show();
}
...
function deleteRecord(id, pondId) {
    Swal.fire({
        ...
        fetch('process_simple_salinity.php', {
        method: 'POST',
        headers: {
    ...
    .then(data => {
        if (data.success) {
            ...
            salinityDataTable.ajax.reload(); // Reload DataTable
...
function saveNewRecord() {
    const formData = {
        ...
        salinity_ppt: document.getElementById('new_salinidad_level').value,
    ...
    .then(data => {
        if (data.success) {
            ...
            document.getElementById('newSalinidadForm').reset();
...
function saveEditRecord() {
    const formData = {
        ...
        salinity_ppt: document.getElementById('edit_salinidad_level').value,
    ...
    .then(data => {
        if (data.success) {
            ...
            const modal = bootstrap.Modal.getInstance(document.getElementById('editSalinidadModal'));
            modal.hide();
            salinityDataTable.ajax.reload(); // Reload DataTable
            $(document).trigger('tableUpdated'); // Trigger statistics update
        } else {

...
try {
    ...
    $checkTableQuery = "SHOW TABLES LIKE 'water_temperature_log'";
    ...
    if ($stmt->rowCount() > 0) {
        echo json_encode([
            'success' => true,
            'message' => 'La tabla water_temperature_log ya existe'
        ]);
        exit;
    }
    ...
    echo json_encode([
        'success' => true,
        'message' => 'Tabla water_temperature_log creada exitosamente'
    ]);

...
try {
    ...
    $sql = "SELECT 
                ...
                AVG(transparency_cm) as avg_transparency,
    ...
    foreach ($results as $row) {
        ...
        $pondData[$pondId][$monthKey] = round(floatval($row['avg_transparency']), 2);
    }
    ...
    echo json_encode([
        'success' => false,
        'message' => 'Error al obtener datos de transparencia: ' . $e->getMessage()
    ]);
}

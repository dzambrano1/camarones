...
<title>Camarones Alimento Harinas</title>
<!-- Link to the Favicon -->
...
<!-- Tabla de Estimación de Consumo de Harinas -->
<div class="container-fluid mt-4">
    <div class="card shadow-lg border-0">
        <div class="card-header position-relative overflow-hidden" style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%); color: white;">
            <div class="position-relative">
                <h3 class="mb-0 text-center">
                    <i class="fas fa-seedling me-3" style="color: white;"></i>
                    📊 Estimación de consumo diario de harinas por millón de postlarvas
                    <i class="fas fa-seedling ms-3" style="color: white;"></i>
                </h3>
            </div>
        </div>
        <div class="card-body p-0">
                ...
                <table class="table table-hover mb-0">
                    <thead style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%); color: white;">
                        <tr>
                            ...
                            <th class="text-center"><i class="fas fa-seedling me-2"></i>Harinas (80–90% del alimento)</th>
                            <th class="text-center"><i class="fas fa-balance-scale me-2"></i>Peso de harinas/día</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class="table-row-hover">
                            ...
                            <td class="text-center">
                                <span class="badge bg-success rounded-pill">PL10–PL15</span>
                            </td>
                            <td class="text-center fw-bold text-primary">20 kg/día</td>
                            <td class="text-center">16–18 kg</td>
                            <td class="text-center fw-bold" style="color: #28a745;">16–18 kg</td>
                        </tr>
                        <tr class="table-row-hover">
                            <td class="text-center fw-bold">Día 8–14</td>
                            <td class="text-center">
                                <span class="badge bg-success rounded-pill">PL15–PL20</span>
                            </td>
                            <td class="text-center fw-bold text-primary">15 kg/día</td>
                            <td class="text-center">12–13.5 kg</td>
                            <td class="text-center fw-bold" style="color: #28a745;">12–13.5 kg</td>
                        </tr>
                        <tr class="table-row-hover">
                            <td class="text-center fw-bold">Día 15–21</td>
                            <td class="text-center">
                                <span class="badge bg-success rounded-pill">PL20–PL25</span>
                            </td>
                            <td class="text-center fw-bold text-primary">10 kg/día</td>
                            <td class="text-center">8–9 kg</td>
                            <td class="text-center fw-bold" style="color: #28a745;">8–9 kg</td>
                        </tr>
                        <tr class="table-row-hover">
                            <td class="text-center fw-bold">Día 22–30</td>
                            <td class="text-center">
                                <span class="badge bg-success rounded-pill">PL25–PL30</span>
                            </td>
                            <td class="text-center fw-bold text-primary">8 kg/día</td>
                            <td class="text-center">6.4–7.2 kg</td>
                            <td class="text-center fw-bold" style="color: #28a745;">6.4–7.2 kg</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <div class="card-footer bg-light">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <h6 class="fw-bold text-dark text-start">
                                Formulación típica:
                            </h6>
                            <p class="text-muted mb-0 text-start">45–50% proteína, con base de harina de pescado, soya, trigo, y aditivos funcionales.</p>
                        </div>
                        <div class="mb-3">
                            <h6 class="fw-bold text-dark text-start">
                                Proporción de harinas:
                            </h6>
                            <p class="text-muted mb-0 text-start">80–90% del peso total del alimento seco.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <p class="text-muted mb-0 text-start">4–8 veces al día, según etapa y sistema.</p>
                        </div>
                        <div class="mb-3">
                            <h6 class="fw-bold text-dark text-start">
                                Costo estimado:
                            ...
                            <p class="text-muted mb-0 text-start">
                                USD $1.80–$2.50/kg de mezcla de harinas, dependiendo de calidad y origen.
                            </p>
                        </div>
                    </div>
                </div>
      ...
      <div class="table-responsive">
          <table id="concentradoTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                  try {
                       // Query to get ALL harinas records AND animals without harinas records
                         $harinasQuery = "
                             -- First: All existing harinas records with animal info
                             SELECT 
                                 a.id AS camarones_id,
                                 a.tagid,
                                 a.nombre,
                                 h.cah_harinas_fecha_inicio,
                                 h.cah_harinas_fecha_fin,
                                 h.id AS harinas_record_id,
                                 h.cah_harinas_etapa,
                                 h.cah_harinas_producto,
                                 h.cah_harinas_racion,
                                 h.cah_harinas_costo,
                                 CAST((h.cah_harinas_racion * h.cah_harinas_costo) AS DECIMAL(10,2)) as total_value,
                                 1 AS in_harinas_history,
                                 1 AS sort_order
                             FROM 
                                 cah_harinas h
                             INNER JOIN 
                                 camarones a ON h.cah_harinas_tagid = a.tagid
                             
                             UNION ALL
                             
                             -- Second: Animals without any harinas records
                             SELECT 
                                 a.id AS camarones_id,
                                 a.tagid,
                                 a.nombre,
                                 NULL as cah_harinas_fecha_inicio,
                                 NULL as cah_harinas_fecha_fin,
                                 NULL as harinas_record_id,
                                 NULL as cah_harinas_etapa,
                                 NULL as cah_harinas_producto,
                                 NULL as cah_harinas_racion,
                                 NULL as cah_harinas_costo,
                                 NULL as total_value,
                                 0 AS in_harinas_history,
                                 2 AS sort_order
                             FROM 
                                 camarones a
                             WHERE 
                                 a.tagid NOT IN (SELECT DISTINCT cah_harinas_tagid FROM cah_harinas WHERE cah_harinas_tagid IS NOT NULL)
                             
                             ORDER BY 
                                 sort_order ASC, 
                                 CASE WHEN sort_order = 1 THEN cah_harinas_fecha_inicio END DESC,
                                 CASE WHEN sort_order = 1 THEN harinas_record_id END DESC,
                                 CASE WHEN sort_order = 2 THEN nombre END ASC";

                        $stmt = $conn->prepare($harinasQuery);
                        $stmt->execute();
                        $harinasData = $stmt->fetchAll(PDO::FETCH_ASSOC);

                      // If no data, display a message
                      if (empty($harinasData)) {
                          echo "<tr><td colspan='10' class='text-center'>No hay animales ni registros de harinas</td></tr>";
                      } else {
                          // Get vigencia setting for harinas records
                          $vigencia = 30; // Default value
                          try {
                              $configQuery = "SELECT ca_vencimiento_harinas FROM ca_vencimiento LIMIT 1";
                              $configStmt = $conn->prepare($configQuery);
                              $configStmt->execute();
                              
                              // Explicitly use PDO fetch method
                              $row = $configStmt->fetch(PDO::FETCH_ASSOC);
                              if ($row && isset($row['ca_vencimiento_harinas'])) {
                                  $vigencia = intval($row['ca_vencimiento_harinas']);
                              }
                          } catch (PDOException $e) {
                          ...
                          foreach ($harinasData as $row) {
                              echo "<tr>";
                              
                              // Actions column - Different buttons based on whether record has harinas history
                              ...
                              // Only show Edit and Delete buttons for records with harinas history
                              if ($row['in_harinas_history'] == 1) {
                                  // Edit button
                                  echo '        <button class="btn btn-warning btn-sm edit-concentrado" 
                                                  data-id="'.htmlspecialchars($row['harinas_record_id'] ?? '').'" 
                                                  data-tagid="'.htmlspecialchars($row['tagid'] ?? '').'" 
                                                  data-etapa="'.htmlspecialchars($row['cah_harinas_etapa'] ?? '').'" 
                                                  data-producto="'.htmlspecialchars($row['cah_harinas_producto'] ?? '').'" 
                                                  data-racion="'.htmlspecialchars($row['cah_harinas_racion'] ?? '').'" 
                                                  data-costo="'.htmlspecialchars($row['cah_harinas_costo'] ?? '').'" 
                                                  data-fecha_inicio="'.htmlspecialchars($row['cah_harinas_fecha_inicio'] ?? '').'" 
                                                  data-fecha_fin="'.htmlspecialchars($row['cah_harinas_fecha_fin'] ?? '').'" 
                              ...
                              echo "<td>" . htmlspecialchars($row['cah_harinas_fecha_inicio'] ?? '') . "</td>";
                              // Column 2: Fecha Fin
                              echo "<td>" . htmlspecialchars($row['cah_harinas_fecha_fin'] ?? '') . "</td>";
                              // Column 3: Estanque
                              ...
                              if ($row['in_harinas_history'] == 1) {
                                  // Record has harinas data
                                  // Column 5: Etapa
                                  echo "<td>" . htmlspecialchars($row['cah_harinas_etapa'] ?? 'N/A') . "</td>";
                                  // Column 6: Producto
                                  echo "<td>" . htmlspecialchars($row['cah_harinas_producto'] ?? 'N/A') . "</td>";
                                  // Column 7: Racion
                                  echo "<td>" . htmlspecialchars($row['cah_harinas_racion'] ?? 'N/A') . "</td>";
                                  // Column 8: Costo
                                  echo "<td>" . htmlspecialchars($row['cah_harinas_costo'] ?? 'N/A') . "</td>";
                                  ...
                                  try {
                                      if (!empty($row['cah_harinas_fecha_inicio'])) {
                                          $harinasDate = new DateTime($row['cah_harinas_fecha_inicio']);
                                          $dueDate = clone $harinasDate;
                                      ...
                                      error_log("Date error: " . $e->getMessage() . " for date: " . $row['cah_harinas_fecha_inicio']);
                                      echo '<td class="text-center"><span class="badge bg-secondary">ERROR FECHA</span></td>';
                                  }
                              } else {
                                  // Animal has no harinas history - show placeholder data
...
<div class="container mt-5 mb-5">
    <div class="card shadow">
        ...
        <div class="card-body">
            <div class="row mb-4">
                <div class="col-md-4">
                    <select id="concentradoYearFilter" class="form-select">
...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#concentradoYearFilter').on('change', function() {
    ...
    function populateConcentradoYearFilter(data) {
        ...
        const yearFilter = $('#concentradoYearFilter');
    ...
    function updateConcentradoChart() {
        const selectedYear = $('#concentradoYearFilter').val();
